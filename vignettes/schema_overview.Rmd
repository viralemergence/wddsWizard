...
```{r schema-as-table, include=FALSE}

# wdds_data_required <- wddsWizard::wdds_schema$properties$data$properties[wddsWizard::data_required_fields]
# 
# descriptions <- purrr::map_depth(wdds_data_required,1,"description") 
#   
# df_data_desc <- data.frame(Field = wddsWizard::data_required_fields, Descriptions = unlist(descriptions),row.names = NULL)
# 
# df_data_desc |>
