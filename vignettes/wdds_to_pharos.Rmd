...
![create new dataset](../inst/img/create_new_dataset.png)
...
![pharos upload](../inst/img/uploaded_data_no_mods.png)

If you click publish, a validation report will be generated an any issues will be noted.

![pharos validation report](../inst/img/invalid_dead_or_alive.png)
...
![On no we need blanks not NA](../inst/img/need_blank_nas.png)
```{r blank-nas}
