...
Uses the DOI for a work to extract metadata from OpenAlex -
https://openalex.org/. The OpenAlex data model does not included some
fields that are part of the wdds project metadata related identifiers.
